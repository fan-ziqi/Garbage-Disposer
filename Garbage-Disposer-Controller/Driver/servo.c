...
/**
  ...
  * @返回值  无
  */
void Servo_Laji_L_SetAngle(uint16_t angle)
{
	if(angle > 1800)
		angle = 1800;
...
/**
  ...
  * @返回值  无
  */
void Servo_Laji_R_SetAngle(uint16_t angle)
{
	if(angle > 1800)
		angle = 1800;
...
/**
  ...
  * @返回值  无
  */
void Servo_test_SetAngle(uint16_t angle)
{
	if(angle > 1800)
		angle = 1800;
